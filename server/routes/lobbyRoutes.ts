...
router.post("/create-lobby", (req: Request<unknown, unknown, CreateLobbyRequest>, res: Response<{ message: string }>): void => {
  try {
...
router.get("/check-lobby/:lobbyId", (req: Request<FindLobbyRequest>, res: Response<{ message: string }>): void => {
  try {
